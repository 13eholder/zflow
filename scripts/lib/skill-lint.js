...
// Chinese skills use the equivalent "在……时使用" phrasing.
// Reject negated forms ("Do not use when …", "Don't use when …") — those
// describe exclusions, not trigger conditions.
const DESCRIPTION_TRIGGER        = /\buse (this )?when\b|\buse (before|after|during)\b|时使用/i;
const DESCRIPTION_TRIGGER_NEGATE = /\b(do not|don't|never) use (this )?(when|before|after|during)\b|不要使用|请勿使用/i;
...
// Chinese aliases support the zh-CN skill tree.
